...
class ArtisticContract{
    ...
    public function __construct($id_usuario, $empresa, $nombre, $id_fiscal, $direccion, $firmaOpt, $pais, $telefono, $email, $fecha, $id_empresa){
    ...
    public function guardarContrato(){
        ...
        $mpdf->OutputFile('../public/contracts/'.$this->id_usuario.'-'.$this->id_empresa.'-artistic-'.date('d-m-y').'.pdf');
    }
}